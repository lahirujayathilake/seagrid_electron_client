...
this.barPixels = Clazz_floatToInt (ret[0] * imageFontScaling);
...
if (this.currentObject.pymolOffset == null) this.currentObject.pymolOffset =  Clazz_newFloatArray (-1, [-1, 2, 0, 0, 0, 0, 0]);
}return;
}if ("offset" === propertyName) {
if (this.currentObject != null) {
...
var h = Clazz_doubleToInt ((text.lineHeight) / 3);
var y = Clazz_floatToInt (temp[1]) - i;
g3d.fillTextRect (x1, y - Clazz_doubleToInt (h / 2) - 2 - ia, z, text.zSlab, x2 - x1, 2 * ia);
g3d.fillTextRect (x1, y - Clazz_doubleToInt (h * 3 / 2), z, text.zSlab, 2 * ia, Clazz_doubleToInt (h * 3 / 2));
g3d.fillTextRect (x2, y - Clazz_doubleToInt (h * 3 / 2), z, text.zSlab, 2 * ia, Clazz_doubleToInt (h * 3 / 2));
